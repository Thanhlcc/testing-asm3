...
describe('Testing moodle 5 ', function () {
    this.timeout(60000)
    let driver
    let vars
    ...
    /* //////////////// 5.2   ////////////////       */
    it.only('Testing moodle 5.2 - Alternative flow: Save and show next', async function () {
    ...
    it('Testing moodle 5.5 - Boundary Values', async function () {
        ...
        await driver.sleep(3000)
        {
            const elements = await driver.findElements(By.linkText("00.00"))
            assert(elements.length)
        }
